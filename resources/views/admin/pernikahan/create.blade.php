        ...
        <div class="card-body">
            ...
            <form class="wizard-content mt-2" enctype="multipart/form-data">
                    ...
                    <div class="panel-body" id="panel1">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label class="control-label">KUA</label>
                                    <select class="form-control" name="kua" required>
                                        @foreach ($list_kua as $item)
                            ...
                            {{-- <div class="col">
                                <div class="form-group">
                                    ...
                                    <input maxlength="100" type="text" class="form-control" name="longitude" disabled />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Latitude</label>
                                    <input maxlength="100" type="text" class="form-control" name="latitude" disabled />
                                </div>
                            </div> --}}
                            <input maxlength="100" type="text" class="form-control" name="longitude" disabled hidden/>
                            <input maxlength="100" type="text" class="form-control" name="latitude" disabled hidden/>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control daterange-cus" id="tanggal_lahir"
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input maxlength="100" type="number" required="required"
                                                class="form-control" name="umur_s" id="umur" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control daterange-cus" name="tgl_lahir_i"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="" class="control-label">Ceklis</label>
                                            <div class="form-check">
                                                <input class="form-check-input" name="status_ayah_i" value="1"
                                                    type="checkbox" id="statusAyahI">
                                                <label class="form-check-label" for="gridCheck1">
                                                    Jika Meninggal/Tidak Diketahui
                                                </label>
                                            </div>
                        ...
                        <div class="text-right">
                            <button class="btn btn-primary nextBtn pull-right"
                                data-step="4"type="button">Next</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-primary setup-content" id="step-6">
                    ...
                    <div class="text-right">
                        <button class="btn btn-primary nextBtn pull-right" data-step="6" type="button">Next</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.nextBtn').click(function() {
                var inputElements = $(`#step-${currentStep} .form-control, #step-${currentStep} .form-check-input`)
                var formData = {};
