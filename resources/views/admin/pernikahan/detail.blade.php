        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    ...
                    <a href="{{ route('admin.pernikahan.peta', $pernikahan->id) }}" class="btn btn-info"> <i class="fas fa-map-marker-alt"></i> Petunjuk Arah</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row ml-2">
                ...
                <div class="text-md-right mt-3">
                    ...
                    <a href="{{ route('registrasi-nikah.pdf', $pernikahan->id) }}" class="btn btn-warning btn-icon icon-left"><i class="fas fa-print"></i> Print</a>
                </div>
            </div>
        </div>
    </div>
...
@section('modal')
    <div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form action="{{ route('registrasi-nikah.status', $pernikahan->id) }}" method="POST">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Ubah Status Pernikahan</label>
                            <select class="form-control" name="status">
                                <option value="belum_diproses"
                                    {{ $pernikahan->status == 'belum_diproses' ? 'selected' : '' }}>BELUM DIPROSES
                                </option>
                                <option value="diproses"
                                    {{ $pernikahan->status == 'diproses' ? 'selected' : '' }}>DIPROSES
                                </option>
                                <option value="ditolak" {{ $pernikahan->status == 'ditolak' ? 'selected' : '' }}>
                                    DITOLAK</option>
                                <option value="selesai" {{ $pernikahan->status == 'selesai' ? 'selected' : '' }}>SELESAI
                                </option>
                                <option value="diterima" {{ $pernikahan->status == 'diterima' ? 'selected' : '' }}>
                                    DITERIMA</option>
                            </select>
                        </div>
                    </div>
